        ...
        <div className="flex flex-wrap items-end gap-5">
          <div className="flex flex-col items-center gap-2">
            <ImageUpload
              ...
              onRemove={() => setAvatarCircle(undefined)}
          ...
          <div className="flex flex-col items-center gap-2">
            <ImageUpload
              ...
              shape="square"
              value={avatarSquare}
              onChange={(f) => setAvatarSquare(URL.createObjectURL(f))}
              onRemove={() => setAvatarSquare(undefined)}
            />
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <TimePicker
            ...
            value={step5}
            onChange={setStep5}
            placeholder="Passo de 5 min"
          />
          <TimePicker
            step={15}
            value={step15}
            onChange={setStep15}
            placeholder="Passo de 15 min"
          />
          <TimePicker
            step={30}
            value={step15}
            onChange={setStep15}
            placeholder="Passo de 30 min"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            size="sm"
            variant="secondary"
            onClick={() => toast.success("Aluno salvo com sucesso!")}
          >
          ...
          <Button
            size="sm"
            variant="secondary"
            onClick={() => toast.error("Falha ao excluir registro.")}
          >
          ...
          <Button
            size="sm"
            variant="secondary"
            onClick={() => toast.warning("Limite de alunos próximo.")}
          >
          ...
          <Button
            ...
            onClick={() =>
              toast.error("Aula removida", {
                action: {
                  label: "Restaurar",
                  onClick: () => toast.success("Aula restaurada!"),
                },
...
const molecules: ComponentItem[] = [
  {
    name: "Toast",
    description:
      "Notificações não-bloqueantes com Sonner. Tipos: default, success, error, warning, info, loading, promise. Suporte a description, action e cancel.",
    render: () => <ToastShowcase />,
  },
  {
    name: "Pagination",
    description:
      "Navegação por páginas com ellipsis automático. Variantes: default/glass · Tamanhos: sm/md/lg · Prop showEdges para botões de primeira/última página.",
    render: () => <PaginationShowcase />,
  },
  {
    name: "Upload",
    description:
      "ImageUpload: preview com overlay de câmera, formas circle/square, tamanhos sm–xl. FileUpload: drop zone + lista de arquivos com status loading/success/error.",
    render: () => <UploadShowcase />,
  },
  {
    name: "TimePicker",
    description:
      "Seleção de hora com colunas roláveis. Passo configurável (1/5/10/15/30 min). Suporte a segundos. Estados: default/error/success. Tamanhos: sm/md/lg.",
    render: () => <TimePickerShowcase />,
  },
  {
    name: "DatePicker",
    description:
      "Seleção de data com calendário popover. Variantes: single e range. Estados: default/error/success. Tamanhos: sm/md/lg.",
    render: () => <DatePickerShowcase />,
  },
  {
    name: "Modal",
    description:
      "Compound com Header, Body e Footer. Tamanhos: sm, md, lg, xl. Baseado em Radix Dialog.",
    render: () => (
            ...
            <ModalContent size="sm">
              ...
              <ModalBody>
                <p className="text-sm text-muted-foreground">
                  Tem certeza que deseja continuar? Todos os dados relacionados
  ...
  },
  {
    name: "Tabs",
    description:
      "Variantes: underline (padrão app), pill e glass. Acessível via Radix UI.",
    render: () => (
      <div className="flex flex-col gap-6 w-full">
        {/* Underline */}
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Tabs variant="pill" defaultValue="mensal">
            ...
            <TabsPanel value="mensal">
              <p className="text-sm text-muted-foreground">
                Visão mensal selecionada.
              </p>
            </TabsPanel>
            <TabsPanel value="trimestral">
              <p className="text-sm text-muted-foreground">
                Visão trimestral selecionada.
              </p>
            </TabsPanel>
            <TabsPanel value="anual">
              <p className="text-sm text-muted-foreground">
                Visão anual selecionada.
              </p>
            </TabsPanel>
          </Tabs>
        </div>
  ...
  },
  {
    name: "Avatar",
    description:
      "Imagem com fallback de iniciais, geração de cor por nome, status indicator e AvatarGroup.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        {/* Tamanhos */}
        <div className="flex flex-col gap-2">
  ...
  },
  {
    name: "Badge",
    description:
      "Variantes: default, primary, success, warning, destructive, info, outline. Tamanhos: sm, md.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-2">
          <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">
  ...
  },
  {
    name: "StatusLabel",
    description:
      "Estados semânticos com dot indicator. Status: active, inactive, pending, completed, cancelled, error.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-2">
          <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">
  ...
  },
  {
    name: "Checkbox",
    description:
      "Estados: unchecked, checked, indeterminate. Suporte a label e description.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-2">
          <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">
  ...
  },
  {
    name: "Radio",
    description:
      "Seleção exclusiva entre opções. Suporte a label e description.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-2">
          <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">
  ...
  },
  {
    name: "Switch",
    description:
      "Toggle on/off. Tamanhos: sm, md, lg. Suporte a label e description.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-2">
          <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">
  ...
  },
  {
    name: "Select",
    description:
      "Estados: default, error, success. Tamanhos: sm, md, lg. Suporte a grupos e separadores.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        {/* Estados */}
        <div className="flex flex-col gap-2">
  ...
  },
  {
    name: "Input",
    description:
      "Estados: default, error, success. Tamanhos: sm, md, lg. Slots: leadingIcon, trailingIcon. Compound: InputField.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        {/* Estados */}
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              leadingIcon={<Search />}
              trailingIcon={<EyeOff />}
              placeholder="Large com ícones"
            />
            <Input
              size="sm"
              leadingIcon={<Search />}
              placeholder="Small com ícone"
            />
          </div>
        </div>
  ...
  },
  {
    name: "Textarea",
    description:
      "Estados: default, error, success. Tamanhos: sm, md, lg. Resize: none, y, x, both. Compound: TextareaField.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        {/* Estados */}
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2">
            <Textarea size="sm" rows={5} placeholder="Small" />
            <Textarea size="md" rows={5} placeholder="Medium" />
            <Textarea size="lg" rows={5} placeholder="Large" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2">
            <Textarea resize="none" rows={5} placeholder="resize: none" />
            <Textarea resize="y" rows={5} placeholder="resize: y (padrão)" />
            <Textarea resize="both" rows={5} placeholder="resize: both" />
          </div>
        </div>
  ...
  },
  {
    name: "Button",
    description:
      "Variantes: primary, secondary, ghost, destructive, glass. Tamanhos: sm, md, lg, icon, icon-sm, icon-lg.",
    render: () => (
      <div className="flex flex-col gap-4 w-full">
        {/* Variantes */}
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button size="icon-lg" variant="primary" aria-label="Adicionar">
              <Plus />
            </Button>
            <Button size="icon" variant="destructive" aria-label="Excluir">
              <Trash2 />
            </Button>
            <Button size="icon" variant="glass" aria-label="Download">
              <Download />
            </Button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button size="icon" variant="ghost" disabled aria-label="Disabled">
              <Settings />
            </Button>
          </div>
        </div>
  ...
  },
  {
    name: "Dropdown",
    description:
      "Menu contextual com itens, separadores, labels, checkbox, radio e sub-menus.",
    render: () => <DropdownShowcase />,
  },
  {
    name: "SearchSelect",
    description:
      "Select com busca (client-side e server-side) e infinite scroll via IntersectionObserver.",
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-wrap gap-3">
          <Dropdown>
            <DropdownTrigger asChild>
              <Button variant="glass">
                Minha conta <ChevronRight className="rotate-90" />
              </Button>
            </DropdownTrigger>
            <DropdownContent>
          ...
          <Dropdown>
            <DropdownTrigger asChild>
              <Button size="icon" variant="ghost" aria-label="Opções">
                <Settings />
              </Button>
            </DropdownTrigger>
            <DropdownContent>
      ...
      <div className="flex flex-col gap-2">
        ...
        <Dropdown>
          ...
          <DropdownContent>
            ...
            <DropdownSeparator />
            <DropdownItem variant="destructive" disabled>
              Desabilitado
            </DropdownItem>
          </DropdownContent>
        </Dropdown>
...
const PAGE_SIZE = 8;
const ALL_OPTIONS: SearchSelectOption[] = Array.from(
  { length: 40 },
  (_, i) => ({
    value: `opt-${i + 1}`,
    label: `Opção ${i + 1}`,
