  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header
        ...
        searchPlaceholder="Filtrar por nome, colégio ou série..."
        ...
        actions={
          <button
            className="glass p-2.5 rounded-xl text-slate-400 hover:text-white transition-colors"
      ...
      <div className="mx-auto w-full max-w-7xl p-8 space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        {/* Main Content Card */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="glass-panel p-6 rounded-xl flex items-center gap-4 hover:border-primary/30 transition-colors">
            ...
            <div>
              ...
              <h3 className="text-2xl font-black text-white mt-1">
                {students?.length || 0}{" "}
                {/* Placeholder logic for new students */}
              </h3>
            </div>
          </div>
          <div className="glass-panel p-6 rounded-xl flex items-center gap-4 hover:border-primary/30 transition-colors">
        ...
        <ConfirmModal
          ...
          description={
            <>
              ...
              ? Esta ação removerá permanentemente todos os registros
              vinculados.
            </>
          }
